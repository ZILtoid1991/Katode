module KTextEditor.annotationinterface;

/*
    2008 Andreas Pakulat <apaku@gmx.de>
    2008-2018 Dominik Haumann <dhaumann@kde.org>
 ...
 */
extern(C++, KTextEditor) class AnnotationModel : QObject {
    mixin(Q_OBJECT);
public:
     ...
     */
    QVariant data(int line, Qt.ItemDataRole role) const; // KF6: use int for role
...
// Q_SIGNALS:
     ...
     */
    final void lineChanged(int line) @QSignal;
}
