 ...
 * \sa MovingRange
 */
extern(C++, KTextEditor) class Attribute : QTextCharFormat, QSharedData {
// public:
    /*!
    ...
    alias Ptr = QExplicitlySharedDataPointer!Attribute;
...
extern(C++) public:
     ...
     *
     */
    final void setName(const ref QString name);
     ...
     */
    final KSyntaxHighlighting.Theme.TextStyle defaultStyle() const;
     ...
     *
     */
    final void setDefaultStyle(KSyntaxHighlighting.Theme.TextStyle style);
     ...
     */
    final bool skipSpellChecking() const;
     ...
     *
     */
    final void setSkipSpellChecking(bool skipspellchecking);
     ...
     */
    final void setFontBold(bool bold = true);
     ...
     *
     */
    final void setOutline(const ref QBrush brush);
     ...
     */
    final QBrush selectedForeground() const;
     ...
     *
     */
    final void setSelectedForeground(const ref QBrush foreground);
     ...
     */
    final QBrush selectedBackground() const;
     ...
     *
     */
    final void setSelectedBackground(const ref QBrush brush);
     ...
     */
    final bool backgroundFillWhitespace() const;
     ...
     *
     */
    final void setBackgroundFillWhitespace(bool fillWhitespace);
     ...
     */
    final bool hasAnyProperty() const;
     ...
     *
     */
    final Attribute.Ptr dynamicAttribute(ActivationType type) const;
     ...
     *
     */
    final void setDynamicAttribute(ActivationType type, Attribute.Ptr attribute);
 ...
 */
extern(C++, KTextEditor) extern(C++, class) struct AttributeBlock
{
public:
    /*
