module KTextEditor.abstractannotationitemdelegate;

/*
    2017-2018 Friedrich W. H. Kossebau <kossebau@kde.org>
...
// extern(C++) protected @nogc:
    // explicit StyleOptionAnnotationItem(int _version);
}
...
extern(C++) public:
     ...
     */
    void paint(QPainter painter, const ref KTextEditor.StyleOptionAnnotationItem option,
     ...
     */
    QSize sizeHint(const ref KTextEditor.StyleOptionAnnotationItem option, KTextEditor.AnnotationModel *model,
            int line) const;
     ...
     */
    bool helpEvent(QHelpEvent *event, KTextEditor.View view, const ref KTextEditor.StyleOptionAnnotationItem option,
     ...
     */
    void hideTooltip(KTextEditor.View view);
...
// Q_SIGNALS:
     ...
     *
     */
    final void sizeHintChanged(KTextEditor.AnnotationModel model, int line) @QSignal;
}
